...
class Data {
  ...
  static const mediaItem = MediaItem(id: '1', title: 'title1', idx: 0);
  static final mediaItems = [
    const MediaItem(id: '1', title: 'title1', idx: 0),
    const MediaItem(id: '2', title: 'title2', idx: 0),
    const MediaItem(id: '3', title: 'title3', idx: 0),
  ];
